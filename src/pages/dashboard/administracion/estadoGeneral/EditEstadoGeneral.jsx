...
import EditEstadoGeneralForm from './EditEstadoGeneralForm';




const metadata = { title: `Editar estado general | Dashboard - ${CONFIG.appName}` };
...
export default function EditEjes() {
  ...
  return (
    <>
      ...
      <EditEstadoGeneralForm registroEditar={registroEditar} />
