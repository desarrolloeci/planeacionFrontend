...
const metadata = { title: `Estados generales | Dashboard - ${CONFIG.appName}` };
...
export default function EstadoGeneral() {
    ...
    const getLista = async () => {
        ...
        fetch(`${API_BASE_URL}/parametros/tipo/1`, requestOptions)
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editEstadoGeneral(row.id))
                ...
                <CustomBreadcrumbs
                    ...
                    action={
                        <Button
                            ...
                            href={paths.dashboard.administracion.newEstadoGeneral}
                            variant="contained"
                            color="primary"
                            startIcon={<Iconify icon="mingcute:add-line" />}
                        >
                            Nuevo estado general
                        </Button>
                    }
                    sx={{ mb: { xs: 3, md: 5 } }}
                />
