...
export default function EditTipoRubroForm({ registroEditar }) {
    ...
    return (
        ...
        <DashboardContent sx={{ width: "100%" }}>
            <CustomBreadcrumbs
                heading="Editar tipo de rubro"
                backHref={paths.dashboard.administracion.rootTipoRubro}
                links={[
                    { name: 'Dashboard', href: paths.dashboard.root },
                    { name: 'Tipo de rubro', href: paths.dashboard.administracion.rootTipoRubro },
                    { name: 'Editar tipo de rubro' },
                ]}
                sx={{ mb: { xs: 3, md: 5 } }}
            />
