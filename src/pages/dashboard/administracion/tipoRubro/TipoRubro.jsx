...
const metadata = { title: `Tipo Rubro | Dashboard - ${CONFIG.appName}` };

export default function TipoRubro() {
    ...
    const getLista = async () => {
        ...
        fetch(`${API_BASE_URL}/parametros/tipo/4`, requestOptions)
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editTipoRubro(row.id))
                ...
                <CustomBreadcrumbs
                    ...
                    action={
                        <Button
                            ...
                            href={paths.dashboard.administracion.newTipoRubro}
                            variant="contained"
                            color="primary"
