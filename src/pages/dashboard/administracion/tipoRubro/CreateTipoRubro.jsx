...
const metadata = { title: `Crear Tipo Rubro | Dashboard - ${CONFIG.appName}` };

export default function CreateTipoRubro() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        fetch(`${API_BASE_URL}/parametros`, requestOptions)
            ...
            .then((result) => {
                ...
                navigate(paths.dashboard.administracion.rootTipoRubro)
            })
            .catch((error) => {
    ...
    return (
        <>
            ...
            <DashboardContent sx={{ width: "100%" }}>
                <CustomBreadcrumbs
                    heading="Crear tipo de rubro"
                    backHref={paths.dashboard.administracion.rootTipoRubro}
                    links={[
                        { name: 'Dashboard', href: paths.dashboard.root },
                        { name: 'Tipo rubro', href: paths.dashboard.administracion.rootTipoRubro },
                        { name: 'Nuevo tipo de rubro' },
                    ]}
                    sx={{ mb: { xs: 3, md: 5 } }}
                />
