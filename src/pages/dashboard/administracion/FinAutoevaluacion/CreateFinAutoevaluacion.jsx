...
const metadata = { title: `Crear fin de autoevaluación | Dashboard - ${CONFIG.appName}` };

export default function CreateFinAutoevaluacion() {
    ...
    return (
        <>
            ...
            <DashboardContent sx={{ width: "100%" }}>
                <CustomBreadcrumbs
                    heading="Crear fin de autoevaluación"
                    ...
                    links={[
                        ...
                        { name: 'Nuevo fin de autoevaluación' },
                    ]}
                    sx={{ mb: { xs: 3, md: 5 } }}
                />
