...
const metadata = { title: `Unidades Ejecutoras | Dashboard - ${CONFIG.appName}` };

export default function UnidadEjecutora() {
        ...
        fetch(`${API_BASE_URL}/unidadejecutora`, requestOptions)
            ...
            .then((result) => {
                ...
                resultJSON.forEach(element => {
                    ...
                    var a = {
                        id: element.idunidadej,
                        name: element.nombreunidad,
                        state: element.estadounidadej
                    }
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editUnidadEjecutora(row.id))
                ...
                <CustomBreadcrumbs
                    ...
                    action={
                        <Button
                            ...
                            href={paths.dashboard.administracion.newUnidadEjecutora}
                            variant="contained"
                            color="primary"
