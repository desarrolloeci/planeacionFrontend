...
export default function EditUnidadEjecutoraForm({ registroEditar }) {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        fetch(`${API_BASE_URL}/unidadejecutora/` + registroEditar.id, requestOptions)
    ...
    return (
        ...
        <DashboardContent sx={{ width: "100%" }}>
            <CustomBreadcrumbs
                heading="Editar unidad ejecutora"
