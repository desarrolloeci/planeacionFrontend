...
const metadata = { title: `Estados de ejecución | Dashboard - ${CONFIG.appName}` };

export default function EstadoEjecucion() {
    ...
    const getLista = async () => {
        ...
        fetch(`${API_BASE_URL}/parametros/tipo/2`, requestOptions)
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editEstadoEjecucion(row.id))
    ...
    return (
        <>
            ...
            <DashboardContent>
                <CustomBreadcrumbs
                    heading="Estado Ejecucion"
                    links={[
                        { name: 'Dashboard', href: paths.dashboard.root },
                        { name: 'Estado Ejecucion' },
                    ]}
                    action={
                        <Button
                            component={RouterLink}
                            href={paths.dashboard.administracion.newEstadoEjecucion}
                            variant="contained"
                            color="primary"
                            startIcon={<Iconify icon="mingcute:add-line" />}
                        >
                            Nuevo estado ejecución
                        </Button>
                    }
                    sx={{ mb: { xs: 3, md: 5 } }}
                />
