...
import EditEstadoEjecucionForm from './EditEstadoEjecucionForm';




const metadata = { title: `Editar estado de ejecución | Dashboard - ${CONFIG.appName}` };
...
export default function EditEjes() {
  ...
  return (
    <>
      ...
      <EditEstadoEjecucionForm registroEditar={registroEditar} />
