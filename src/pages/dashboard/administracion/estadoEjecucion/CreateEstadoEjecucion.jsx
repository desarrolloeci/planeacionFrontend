...
const metadata = { title: `Crear Estado Ejecucion | Dashboard - ${CONFIG.appName}` };

export default function CreateEstadoEjecucion() {
    ...
    return (
        <>
            ...
            <DashboardContent sx={{ width: "100%" }}>
                <CustomBreadcrumbs
                    heading="Crear estado ejecucion"
