...
const metadata = { title: `Snies | Dashboard - ${CONFIG.appName}` };
...
export default function Snies() {
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editSnies(row.id))
                ...
                <CustomBreadcrumbs
                    ...
                    action={
                        <Button
                            ...
                            href={paths.dashboard.administracion.newSnies}
                            variant="contained"
                            color="primary"
