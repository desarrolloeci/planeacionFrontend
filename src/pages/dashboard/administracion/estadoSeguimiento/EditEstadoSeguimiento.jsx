...
import EditEstadoSeguimientoForm from './EditEstadoSeguimientoForm';




const metadata = { title: `Editar estado seguimiento | Dashboard - ${CONFIG.appName}` };
...
export default function EditEjes() {
  ...
  return (
    <>
      ...
      <EditEstadoSeguimientoForm registroEditar={registroEditar} />
