...
const metadata = { title: `Crear Estado Seguimiento | Dashboard - ${CONFIG.appName}` };

export default function CreateEstadoSeguimiento() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        fetch(`${API_BASE_URL}/parametros`, requestOptions)
            ...
            .then((result) => {
                ...
                navigate(paths.dashboard.administracion.rootEstadoSeguimiento)
            })
            .catch((error) => {
    ...
    return (
        <>
            ...
            <DashboardContent sx={{ width: "100%" }}>
                <CustomBreadcrumbs
                    heading="Crear estado seguimiento"
                    backHref={paths.dashboard.administracion.rootEstadoSeguimiento}
                    links={[
                        { name: 'Dashboard', href: paths.dashboard.root },
                        { name: 'Estado seguimiento', href: paths.dashboard.administracion.rootEstadoSeguimiento },
                        { name: 'Nuevo estado seguimiento' },
                    ]}
                    sx={{ mb: { xs: 3, md: 5 } }}
                />
