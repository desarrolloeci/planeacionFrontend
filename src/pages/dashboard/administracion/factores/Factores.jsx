...
const metadata = { title: `Factores | Dashboard - ${CONFIG.appName}` };
...
export default function Factores() {
    ...
    const actualizar = (row) => {
        ...
        navigate(paths.dashboard.administracion.editFactores(row.id))
                ...
                <CustomBreadcrumbs
                    ...
                    action={
                        <Button
                            ...
                            href={paths.dashboard.administracion.newFactores}
                            variant="contained"
                            color="primary"
